/*
  # Update Partners Schema and Add Referral Tracking
  
  1. Changes
    - Add partners table if it doesn't exist
    - Add referral tracking columns to existing tables if they don't exist
